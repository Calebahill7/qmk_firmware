...
led_setup_t leds_purple[] = {
    { .hs = 0, .he = 100, .rs = 122, .re = 122, .gs = 6, .ge = 6, .bs = 216, .be = 216, .ef = EF_NONE },
    { .end = 1 },
};
...
//Green+Red to match mouse
led_setup_t leds_green_red[] = {
	{ .hs = 0, .he = 16.67, .rs = 0, .re = 70, .gs = 255, .ge = 255, .bs = 0, .be = 0, .ef = EF_OVER },
	{ .hs = 16.67, .he = 33.33, .rs = 255, .re = 255, .gs = 70, .ge = 0, .bs = 0, .be = 0, .ef = EF_OVER },
	{ .hs = 33.33, .he = 50, .rs = 255, .re = 255, .gs = 0, .ge = 0, .bs = 0, .be = 0, .ef = EF_OVER },
    { .hs = 50, .he = 66.67, .rs = 255, .re = 255, .gs = 0, .ge = 0, .bs = 0, .be = 0, .ef = EF_OVER },
	{ .hs = 66.67, .he = 83.33, .rs = 255, .re = 255, .gs = 0, .ge = 70, .bs = 0, .be = 0, .ef = EF_OVER },
	{ .hs = 83.33, .he = 100, .rs = 70, .re = 0, .gs = 255, .ge = 255, .bs = 0, .be = 0, .ef = EF_OVER },
    { .end = 1 },
};
...
//Logitech-Mouse-Blue
led_setup_t logitech_blue[] = {
    { .hs = 0, .he = 100, .rs = 0, .re = 0, .gs = 255, .ge = 255, .bs = 235, .be = 235, .ef = EF_NONE },
    { .end = 1 },
};
