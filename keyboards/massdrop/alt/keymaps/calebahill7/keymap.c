...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
        ...
        KC_TRNS, L_T_MD,  L_PSI,   EMAIL,   SPAM,    CJCLDS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PAUS, KC_TRNS, KC_SLCK, KC_INS,  KC_MUTE, \
        KC_TRNS, L_PTP,   L_PSD,   L_PTN,   L_T_PTD, L_T_BR,  KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_TRNS,          KC_TRNS, KC_VOLU, \
        KC_TRNS, L_BRD,   L_BRI,   KC_CALC, KC_TRNS, KC_TRNS, TG_NKRO, KC_TRNS, KC_BRID, KC_BRIU, KC_TRNS, KC_TRNS,          KC_PGUP, KC_VOLD, \
	...
	[2] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, \
        KC_TRNS, GUI_TOGGLE, MAGIC_UNHOST_NKRO,               MAGIC_HOST_NKRO,                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS  \
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
	...
	switch (keycode) {
		...
		case SPAM:
			if (record->event.pressed) {
				// when keycode SPAM is pressed
				SEND_STRING("chill.cake.calcs.777@gmail.com");
			} else {
				// when keycode SPAM is released
			}
			return false;
		case CJCLDS:
			if (record->event.pressed) {
